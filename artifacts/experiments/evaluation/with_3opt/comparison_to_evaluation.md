...
- **Reduced 3-opt average-best-deviation deltas: Baseline +4.06 pp, Strict MSA +3.97 pp, Rooted MSA +4.14 pp, Cycle cover +2.53 pp, Cycle-cover patching +1.66 pp, Cycle-cover MSA patching +1.78 pp.**
- **Reduced 3-opt success-rate deltas: Baseline +30.74 pp, Strict MSA +32.52 pp, Rooted MSA +33.93 pp, Cycle cover +27.19 pp, Cycle-cover patching +30.00 pp, Cycle-cover MSA patching +28.30 pp.**
- **Deviation gain over baseline with and without 3-opt: Strict MSA +0.11 -> +0.02 pp, Rooted MSA -0.05 -> +0.02 pp, Cycle cover +1.81 -> +0.28 pp, Cycle-cover patching +2.66 -> +0.26 pp, Cycle-cover MSA patching +2.54 -> +0.26 pp.**
- **Signal remaining after enabling 3-opt: Strict MSA 17.35%, Rooted MSA 45.77%, Cycle cover 15.24%, Cycle-cover patching 9.77%, Cycle-cover MSA patching 10.29%.**
...
<tr><td>Cycle-cover patching</td><td align="right">1.94</td><td align="right">0.28</td><td align="right">18.37</td><td align="right">48.37</td></tr>
...
<tr><td>Cycle-cover patching</td><td align="right">+2.66</td><td align="right">+0.26</td><td align="right">9.77</td></tr>
